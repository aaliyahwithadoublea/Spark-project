...
>
        ...
        <div className="flex justify-between items-center h-full lg:gap-x-16">
          ...
          <ul className="hidden lg:flex space-x-12 text-black font-semibold items-center">
            <li><a href="#about" className="hover:text-[#AED317]">About</a></li>
            <li><a href="#services" className="hover:text-[#AED317]">Services</a></li>
            <li><a href="#results" className="hover:text-[#AED317]">Results</a></li>
            <li><a href="#faq" className="hover:text-[#AED317]">FAQ</a></li>
            <li>
        ...
        {/* Mobile Menu */}
        {isMenuOpen && (
          <div className="absolute top-[80px] left-0 w-full bg-[#F8F8F6] p-6 z-40 ">
            <ul className="flex flex-col space-y-4 text-black font-semibold">
              <li><a href="#about" onClick={toggleMenu} className="hover:text-[#AED317]">About</a></li>
              <li><a href="#services" onClick={toggleMenu} className="hover:text-[#AED317]">Services</a></li>
              <li><a href="#results" onClick={toggleMenu} className="hover:text-[#AED317]">Results</a></li>
              <li><a href="#faq" onClick={toggleMenu} className="hover:text-[#AED317]">FAQ</a></li>
              <li className="pt-4">
                <button
                  onClick={toggleMenu}
